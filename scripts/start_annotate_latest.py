"""
Quick start annotation interface for latest dataset (最新資料)
"""
import subprocess
import webbrowser
import time
...
# Dataset path
CUSTOM_PATH = r"d:\專案\candy\datasets\最新資料\images"

print("=" * 80)
print("Starting latest dataset annotation interface...")
...
print("   - Click 'Preview All' to see all images")
